  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 font-display text-xl text-foreground">No encontramos esta página</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          La dirección no existe o ha cambiado. Desde el inicio puedes volver al mercado.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ha fallado algo por nuestra parte. Puedes reintentar o volver al inicio.
        </p>
